...
/* UDP interface node														*/
/* this node configures an UDP communication between the robotic platform	*/
/* and the BCI. It advertises the topic /interface_request usefull for the 	*/
/* planner to know the patient needs. this topic recieves the BCI menu to	*/ 
/* show to the patient and replies the BCI response in this menu    		*/
/****************************************************************************/
"""
import rospy
import time
